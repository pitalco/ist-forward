...
// @ts-ignore
import { parseICS20TransferPacket, makeICS20TransferPacketAck, assertICS20TransferPacketAck } from '@agoric/pegasus';
 ...
 */
/**
 * @param {ZCF<{board: ERef<BoardDepositFacet>, namesByAddress: ERef<import('@agoric/vats').NameHub>, network: ERef<Protocol>}>} zcf
 */
